...
#[test]
fn test_bmi_taken_no_page_cross() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x8000;
    cpu.set_flag(Flag::Negative, true); // N = 1, so branch is taken
...
fn test_bmi_not_taken() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x8000;
    cpu.set_flag(Flag::Negative, false); // N = 0, so no branch
...
#[test]
fn test_bmi_taken_with_page_cross() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x80FE;
    cpu.set_flag(Flag::Negative, true); // N = 1, should branch

    cpu.memory[0x80FE] = 0x03; // offset must be at current PC
    cpu.rel(); // now reads 0x03, sets addr_rel, pc = 0x80FF
    cpu.bmi(); // 0x80FF + 3 = 0x8102 (page cross)

    assert_eq!(cpu.pc, 0x8102); // should be 0x80FF + 3
}

#[test]
fn test_bvc_taken_no_page_cross() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x8000;
    cpu.set_flag(Flag::Overflow, false); // N = 0, so branch is taken
...
fn test_bvc_not_taken() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x8000;
    cpu.set_flag(Flag::Overflow, true); // N = 1, so no branch
...
#[test]
fn test_bvc_taken_with_page_cross() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x80FE;
    cpu.set_flag(Flag::Overflow, false); // N = 0, should branch

    cpu.memory[0x80FE] = 0x03; // offset must be at current PC
    cpu.rel(); // now reads 0x03, sets addr_rel, pc = 0x80FF
    cpu.bvc(); // 0x80FF + 3 = 0x8102 (page cross)

    assert_eq!(cpu.pc, 0x8102); // should be 0x80FF + 3
}

#[test]
fn test_bvs_taken_no_page_cross() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x8000;
    cpu.set_flag(Flag::Overflow, true); // N = 1, so branch is taken
...
fn test_bvs_not_taken() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x8000;
    cpu.set_flag(Flag::Overflow, false); // N = 0, so no branch
...
#[test]
fn test_bvs_taken_with_page_cross() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x80FE;
    cpu.set_flag(Flag::Overflow, true); // N = 1, should branch

    cpu.memory[0x80FE] = 0x03; // offset must be at current PC
    cpu.rel(); // now reads 0x03, sets addr_rel, pc = 0x80FF
    cpu.bvs(); // 0x80FF + 3 = 0x8102 (page cross)
...
#[test]
fn test_bcs_taken_no_page_cross() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x8000;
    cpu.set_flag(Flag::Carry, true); // N = 1, so branch is taken
...
fn test_bcs_not_taken() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x8000;
    cpu.set_flag(Flag::Carry, false); // N = 0, so no branch
...
#[test]
fn test_bcs_taken_with_page_cross() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x80FE;
    cpu.set_flag(Flag::Carry, true); // N = 1, should branch

    cpu.memory[0x80FE] = 0x03; // offset must be at current PC
    cpu.rel(); // now reads 0x03, sets addr_rel, pc = 0x80FF
    cpu.bcs(); // 0x80FF + 3 = 0x8102 (page cross)
...
fn test_bne_taken_no_page_cross() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x8000;
    cpu.set_flag(Flag::Zero, false); // N = 0, so branch is taken
...
fn test_bne_not_taken() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x8000;
    cpu.set_flag(Flag::Zero, true); // N = 1, so no branch
...
fn test_bne_taken_with_page_cross() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x80FE;
    cpu.set_flag(Flag::Zero, false); // N = 1, should branch

    cpu.memory[0x80FE] = 0x03; // offset must be at current PC
    cpu.rel(); // now reads 0x03, sets addr_rel, pc = 0x80FF
    cpu.bne(); // 0x80FF + 3 = 0x8102 (page cross)
...
fn test_beq_taken_no_page_cross() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x8000;
    cpu.set_flag(Flag::Zero, true); // N = 1, so branch is taken
...
fn test_beq_not_taken() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x8000;
    cpu.set_flag(Flag::Zero, false); // N = 0, so no branch
...
fn test_beq_taken_with_page_cross() {
    let mut cpu = Cpu::default();
    cpu.pc = 0x80FE;
    cpu.set_flag(Flag::Zero, true); // N = 0, should branch

    cpu.memory[0x80FE] = 0x03; // offset must be at current PC
    cpu.rel(); // now reads 0x03, sets addr_rel, pc = 0x80FF
    cpu.beq(); // 0x80FF + 3 = 0x8102 (page cross)
